...
def store_train_test_splits(output_path, train_E, train_E_false, test_E, test_E_false, split_id=0):
    ...
    filenames = (os.path.join(output_path, "trE_{}_{}.csv".format(split_id, config.lp_train_frac)),
                 os.path.join(output_path, "negTrE_{}_{}.csv".format(split_id, config.lp_train_frac)),
                 os.path.join(output_path, "teE_{}_{}.csv".format(split_id, config.lp_train_frac)),
                 os.path.join(output_path, "negTeE_{}_{}.csv".format(split_id, config.lp_train_frac)))
