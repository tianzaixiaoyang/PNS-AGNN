...
from src.EvalNE.evalne.evaluation import score
from src.EvalNE.evalne.evaluation import split
from src.EvalNE.evalne.evaluation import edge_embeddings
from src.EvalNE.evalne.methods import katz
from src.EvalNE.evalne.methods import similarity as sim
from src.EvalNE.evalne.utils import util
...
class LPEvaluator(object):
    ...
    >>> from src.EvalNE.evalne.evaluation.split import LPEvalSplit
    >>> from src.EvalNE.evalne.utils import preprocess as pp
...
class NREvaluator(LPEvaluator):
    ...
    >>> from src.EvalNE.evalne.evaluation.evaluator import NREvaluator
    >>> from src.EvalNE.evalne.evaluation.split import NREvalSplit
    >>> from src.EvalNE.evalne.utils import preprocess as pp
    >>> # Load and preprocess a network
    >>> G = pp.load_graph('./evalne/tests/data/network.edgelist')
    >>> G, _ = pp.prep_graph(G)
...
class SPEvaluator(LPEvaluator):
    ...
    >>> from src.EvalNE.evalne.evaluation.evaluator import SPEvaluator
    >>> from src.EvalNE.evalne.evaluation.split import SPEvalSplit
    >>> from src.EvalNE.evalne.utils import preprocess as pp
    >>> # Load and preprocess a network
...
class NCEvaluator(object):
    ...
    def __init__(self, G, labels, nw_name, num_shuffles, traintest_fracs, trainvalid_frac, dim=128,
                 nc_model=LogisticRegressionCV(Cs=10, cv=3, max_iter=5000, penalty='l2', multi_class='ovr')):
        # General evaluation parameters
        self.G = G
